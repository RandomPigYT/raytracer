...
/*
 Functions:
  ...
  CGLM_INLINE void glm_persp_decomp_z_rh_no(mat4 proj,
                                            float * __restrict nearZ,
                                            float * __restrict farZ)
  CGLM_INLINE void glm_persp_decomp_far_rh_no(mat4 proj, float * __restrict
 farZ) CGLM_INLINE void glm_persp_decomp_near_rh_no(mat4 proj, float *
 __restrict nearZ) CGLM_INLINE void glm_persp_sizes_rh_no(mat4 proj, float
 fovy, vec4 dest)
 */
 ...
 */
CGLM_INLINE
void glm_frustum_rh_no(float left, float right, float bottom, float top,
 ...
 */
CGLM_INLINE
void glm_perspective_rh_no(float fovy, float aspect, float nearZ, float farZ,
                           mat4 dest) {
  float f, fn;
 ...
 */
CGLM_INLINE
void glm_persp_decomp_rh_no(mat4 proj, float *__restrict nearZ,
...
void glm_persp_decompv_rh_no(mat4 proj, float dest[6]) {
  glm_persp_decomp_rh_no(proj, &dest[0], &dest[1], &dest[2], &dest[3], &dest[4],
                         &dest[5]);
}
 ...
 */
CGLM_INLINE
void glm_persp_decomp_x_rh_no(mat4 proj, float *__restrict left,
                              float *__restrict right) {
 ...
 */
CGLM_INLINE
void glm_persp_decomp_y_rh_no(mat4 proj, float *__restrict top,
                              float *__restrict bottom) {
 ...
 */
CGLM_INLINE
void glm_persp_decomp_z_rh_no(mat4 proj, float *__restrict nearZ,
                              float *__restrict farZ) {
  float m32, m22;
 ...
 */
CGLM_INLINE
void glm_persp_decomp_far_rh_no(mat4 proj, float *__restrict farZ) {
 ...
 */
CGLM_INLINE
float glm_persp_fovy_rh_no(mat4 proj) { return glm_persp_fovy(proj); }
 ...
 */
CGLM_INLINE
float glm_persp_aspect_rh_no(mat4 proj) { return glm_persp_aspect(proj); }
