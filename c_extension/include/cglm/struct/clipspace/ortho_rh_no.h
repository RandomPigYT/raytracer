 ...
 */
CGLM_INLINE
mat4s glms_ortho_aabb_rh_no(vec3s box[2]) {
  mat4s dest;
  vec3 rawBox[2];
 ...
 */
CGLM_INLINE
mat4s glms_ortho_aabb_p_rh_no(vec3s box[2], float padding) {
  mat4s dest;
  vec3 rawBox[2];
 ...
 */
CGLM_INLINE
mat4s glms_ortho_aabb_pz_rh_no(vec3s box[2], float padding) {
  mat4s dest;
  vec3 rawBox[2];
 ...
 */
CGLM_INLINE
mat4s glms_ortho_default_rh_no(float aspect) {
  mat4s dest;
 ...
 */
CGLM_INLINE
mat4s glms_ortho_default_s_rh_no(float aspect, float size) {
  mat4s dest;
