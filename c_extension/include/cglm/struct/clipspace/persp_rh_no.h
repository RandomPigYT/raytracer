...
/*
 Functions:
   ...
   CGLM_INLINE void  glms_persp_decomp_x_rh_no(mat4s proj, float *left, float
 *right) CGLM_INLINE void  glms_persp_decomp_y_rh_no(mat4s proj, float *top,
 float *bottom) CGLM_INLINE void  glms_persp_decomp_z_rh_no(mat4s proj, float
 *nearv, float *farv) CGLM_INLINE void  glms_persp_decomp_far_rh_no(mat4s proj,
 float *farZ) CGLM_INLINE void  glms_persp_decomp_near_rh_no(mat4s proj, float
 *nearZ) CGLM_INLINE float glms_persp_fovy_rh_no(mat4s proj) CGLM_INLINE float
 glms_persp_aspect_rh_no(mat4s proj) CGLM_INLINE vec4s
 ...
 */
CGLM_INLINE
mat4s glms_frustum_rh_no(float left, float right, float bottom, float top,
                         float nearZ, float farZ) {
  mat4s dest;
 ...
 */
CGLM_INLINE
mat4s glms_perspective_rh_no(float fovy, float aspect, float nearZ,
                             float farZ) {
  mat4s dest;
 ...
 * struct.raw like glms_persp_move_far_rh_no(prooj.raw, deltaFar) to avoid
 ...
 *
 * NOTE: if you dodn't want to create new matrix then use array api on
 * struct.raw like glm_perspective_resize_rh_no(proj.raw, aspect) to avoid
 * create new mat4 each time
 *
 ...
 */
CGLM_INLINE
void glms_persp_decomp_rh_no(mat4s proj, float *__restrict nearZ,
 ...
 */
CGLM_INLINE
void glms_persp_decompv_rh_no(mat4s proj, float dest[6]) {
 ...
 */
CGLM_INLINE
void glms_persp_decomp_x_rh_no(mat4s proj, float *__restrict left,
                               float *__restrict right) {
 ...
 */
CGLM_INLINE
void glms_persp_decomp_y_rh_no(mat4s proj, float *__restrict top,
 ...
 */
CGLM_INLINE
void glms_persp_decomp_z_rh_no(mat4s proj, float *__restrict nearZ,
 ...
 */
CGLM_INLINE
float glms_persp_fovy_rh_no(mat4s proj) {
 ...
 */
CGLM_INLINE
float glms_persp_aspect_rh_no(mat4s proj) {
