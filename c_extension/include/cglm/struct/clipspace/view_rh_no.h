 ...
 */
CGLM_INLINE
mat4s glms_lookat_rh_no(vec3s eye, vec3s center, vec3s up) {
  mat4s dest;
 ...
 */
CGLM_INLINE
mat4s glms_look_rh_no(vec3s eye, vec3s dir, vec3s up) {
  mat4s dest;
 ...
 */
CGLM_INLINE
mat4s glms_look_anyup_rh_no(vec3s eye, vec3s dir) {
  mat4s dest;
