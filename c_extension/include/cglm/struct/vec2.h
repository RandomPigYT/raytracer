 ...
 */
CGLM_INLINE
float glms_vec2_dot(vec2s a, vec2s b) { return glm_vec2_dot(a.raw, b.raw); }
 ...
 */
CGLM_INLINE
float glms_vec2_cross(vec2s a, vec2s b) { return glm_vec2_cross(a.raw, b.raw); }
 ...
 */
CGLM_INLINE
float glms_vec2_norm2(vec2s v) { return glm_vec2_norm2(v.raw); }
 ...
 */
CGLM_INLINE
float glms_vec2_norm(vec2s v) { return glm_vec2_norm(v.raw); }
