...
/*
 ...
 Functions:
   ...
   CGLM_INLINE vec4s glms_vec4_smoothstep_uni(float edge0, float edge1, vec4s
 ...
 */
CGLM_INLINE
float glms_vec4_dot(vec4s a, vec4s b) { return glm_vec4_dot(a.raw, b.raw); }
 ...
 */
CGLM_INLINE
float glms_vec4_norm2(vec4s v) { return glm_vec4_norm2(v.raw); }
 ...
 */
CGLM_INLINE
float glms_vec4_norm(vec4s v) { return glm_vec4_norm(v.raw); }
 ...
 */
CGLM_INLINE
float glms_vec4_norm_one(vec4s v) { return glm_vec4_norm_one(v.raw); }
 ...
 */
CGLM_INLINE
float glms_vec4_norm_inf(vec4s v) { return glm_vec4_norm_inf(v.raw); }
